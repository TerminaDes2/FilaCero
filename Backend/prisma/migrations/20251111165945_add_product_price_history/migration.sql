...
-- CreateIndex
CREATE INDEX "producto_historial_precio_id_producto_vigente_idx" ON "public"."producto_historial_precio"("id_producto", "vigente");

-- CreateIndex
CREATE INDEX "producto_historial_precio_id_producto_fecha_inicio_idx" ON "public"."producto_historial_precio"("id_producto", "fecha_inicio");
...
-- AddForeignKey
ALTER TABLE "public"."producto_historial_precio" ADD CONSTRAINT "producto_historial_precio_id_producto_fkey" FOREIGN KEY ("id_producto") REFERENCES "public"."producto"("id_producto") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."producto_historial_precio" ADD CONSTRAINT "producto_historial_precio_id_usuario_fkey" FOREIGN KEY ("id_usuario") REFERENCES "public"."usuarios"("id_usuario") ON DELETE SET NULL ON UPDATE CASCADE;
