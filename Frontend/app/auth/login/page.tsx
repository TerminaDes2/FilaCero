  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-white via-white to-brand-50 transition-colors duration-500 dark:from-slate-950 dark:via-slate-950/95 dark:to-slate-950">
      ...
      <div className="relative z-10 flex min-h-screen flex-col px-4 py-8 sm:px-6 sm:py-10 lg:px-12 lg:py-12">
        <header className="flex items-center justify-between rounded-full border border-white/60 bg-white/75 px-4 py-2 backdrop-blur-md shadow-sm transition dark:border-slate-800/80 dark:bg-slate-950/80 dark:text-slate-100 dark:shadow-[0_18px_42px_-28px_rgba(2,6,23,0.75)]">
          <BrandLogo withWordmark size={42} asLink={true} />
          <div className="flex items-center gap-2 rounded-full border border-white/60 bg-white/80 px-3 py-1.5 text-sm font-medium text-slate-700 backdrop-blur-sm shadow-sm dark:border-slate-800/80 dark:bg-slate-950/70 dark:text-slate-200">
            <LanguageSelector />
          </div>
        </header>
