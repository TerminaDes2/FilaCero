      ...
      <div className="mb-10 flex flex-col gap-4 md:gap-6">
        ...
        <div className="grid md:grid-cols-[220px_1fr] gap-10">
          <aside className="hidden md:block">
            <nav className="sticky top-28 text-[13px] space-y-2">
              ...
              <ul className="space-y-1.5">
                ...
                <li>
                  <a href="#contacto" className="block px-2 py-1 rounded hover:bg-brand-50/70 dark:hover:bg-white/5 text-gray-600 dark:text-slate-300 hover:text-brand-700 dark:hover:text-brand-300 focus:outline-none focus:ring-1 focus:ring-brand-400">10. Contacto</a>
                </li>
              </ul>
            </nav>
          </aside>
          <article className="prose dark:prose-invert prose-sm max-w-none">
            ...
            <p className="mt-8">Para los Términos de Servicio visita <Link href="/legal/terminos" className="text-brand-600 dark:text-brand-400 font-medium">esta página →</Link></p>
