...
export default function SortBar() {
  ...
  return (
    <nav className="sticky top-16 z-30 border-y border-[var(--fc-border-soft)] bg-white/85 backdrop-blur" aria-label="Ordenar y filtrar">
        ...
        <div className="no-scrollbar flex gap-2 overflow-x-auto py-3 sm:flex-wrap sm:items-center sm:overflow-visible sm:py-2">
          {sorts.map((s) => {
            ...
            return (
              <button
                ...
                className={`whitespace-nowrap rounded-full border px-4 py-2 text-[12px] font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--fc-brand-300)] focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
                  isActive
          ...
          <div className="flex gap-2 sm:ml-auto">
            <button
              ...
              className={`whitespace-nowrap rounded-full border px-4 py-2 text-[12px] font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
                status === "activo"
