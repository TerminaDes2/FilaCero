      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <div className="h-14 flex items-center gap-3">
          ...
          <div className="ml-1 flex items-center gap-2">
            ...
            <Link href="/auth/register" className="inline-flex h-10 items-center px-3 rounded-full text-sm font-semibold text-slate-800 bg-slate-200/60 hover:bg-slate-300">Sign Up</Link>
          </div>
        </div>
      </div>
    </header>
