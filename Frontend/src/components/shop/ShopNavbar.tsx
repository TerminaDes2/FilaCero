        ...
        <div className="h-14 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="relative w-full">
              ...
              />
              {query && (
                <button onClick={clear} aria-label={t('shop.nav.searchClearAria')} className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
                  {/* X icon */}
          ...
          <div className="ml-1 flex items-center gap-2">
            {/* Bell */}
            <button aria-label={t('shop.nav.notificationsAria')} className="hidden md:inline-flex items-center justify-center w-10 h-10 rounded-full border border-slate-200 text-slate-600 hover:bg-slate-50">
            ...
            {/* Cart */}
            <Link href="/checkout" className="relative inline-flex items-center gap-2 pl-3 pr-3 h-10 rounded-full bg-red-600 text-white hover:bg-red-700">
            ...
            {/* Auth */}
            <Link href="/auth/login" className="hidden sm:inline-flex h-10 items-center px-3 rounded-full text-sm font-medium text-slate-700 hover:bg-slate-50 border border-slate-200">{t('navbar.login')}</Link>
            <Link href="/auth/register" className="inline-flex h-10 items-center px-3 rounded-full text-sm font-semibold text-slate-800 bg-slate-200/60 hover:bg-slate-300">{t('navbar.signup')}</Link>
          </div>
        </div>
      </div>
    </header>
