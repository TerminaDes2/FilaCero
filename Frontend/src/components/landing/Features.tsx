            ...
            return (
              <Reveal delay={70*i} key={f.title} className="relative group">
                <div
                  ...
                  <h3 className="text-base font-semibold mb-1.5 text-gray-800 tracking-tight dark:text-slate-100">{f.title}</h3>
                  <p className="text-sm text-gray-600 leading-relaxed dark:text-slate-300">{f.description}</p>
                </div>
              </Reveal>
            );
          })}
