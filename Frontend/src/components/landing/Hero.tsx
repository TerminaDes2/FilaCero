        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          <Reveal className="space-y-7" >
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <Link href="#process" className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold border border-gray-300/70 text-gray-700 hover:border-brand-500 hover:text-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 transition">
                Ver cómo funciona
              </Link>
            ...
            <p className="text-sm text-gray-600 pt-1">
              ¿Ya tienes cuenta? <Link href="/auth/login" className="font-medium text-brand-600 hover:underline">Inicia sesión</Link>
            </p>
          </Reveal>
