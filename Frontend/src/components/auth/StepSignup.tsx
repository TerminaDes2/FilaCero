            ...
            <div className="mt-6 hidden lg:grid gap-3 text-sm text-slate-500">
              ...
              <ul className="grid gap-2 text-sm text-slate-600">
                <li className="inline-flex items-center gap-3 rounded-2xl border border-white/70 bg-white/75 px-4 py-3 shadow-sm">
                  ...
                  <span>Escoge tu rol para activar la experiencia correcta.</span>
                </li>
                <li className="inline-flex items-center gap-3 rounded-2xl border border-white/70 bg-white/75 px-4 py-3 shadow-sm">
                  ...
                  <span>Completa un formulario inteligente con bloques adaptados a tu objetivo.</span>
                </li>
                <li className="inline-flex items-center gap-3 rounded-2xl border border-white/70 bg-white/75 px-4 py-3 shadow-sm">
                  ...
                  <span>Accede a la plataforma con onboarding guiado y recursos curados.</span>
                </li>
              </ul>
            </div>
          </div>
